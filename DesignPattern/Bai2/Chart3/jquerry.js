...
$(document).ready(function() {
  var myDonutChart = (function () { 
	...
	var centerY = myCanvas.height/2; console.log(centerY);
	var data = {
		"Xuất sắc": 10,
		"Tốt": 20,
		"Trung Bình": 10,
   ...
   //function draw Pie Slice  of Circle
	...
	function drawText(data,colors) {
		...
		for (categ in data) {
			val = data[categ];
			str += "<li style='margin-bottom:10px;'><span style='display:inline-block; width:20px;margin-right:15px; background-color:" +colors[colorsIndex++]
		            +"'>&nbsp;</span>" + categ + "</li>";
		}
		console.log(str);
		$("#content").append(str);
